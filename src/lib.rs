...
impl Config {
    ...
    #[inline]
    fn from_environment_variable(environment_variable_prefix: &str, fallback_cfg: Self) -> Self {
        Config {
...
pub fn try_init_custom_env(
    ...
    let cfg = Config::from_environment_variable(environment_variable_name, config);
